...
const TenantDashboard: React.FC = () => {
  ...
  // When user confirms unlock
  const handleConfirmUnlock = () => {
    setIsModalOpen(false);

    // Simulate success modal after unlocking
    setTimeout(() => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen space-y-8">
      {/* Overview Section */}
      <h1 className="text-[#2F3639] font-semibold text-[14px]">Your Overview</h1>
      ...
      <section>
        <h2 className="text-sm text-[#2F3639] font-semibold">Recommended for You</h2>
